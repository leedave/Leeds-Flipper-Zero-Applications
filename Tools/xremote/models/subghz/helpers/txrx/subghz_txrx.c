...
//#include <lib/subghz/blocks/custom_btn.h> //no present in OFW
...
void subghz_txrx_reset_dynamic_and_custom_btns(SubGhzTxRx* instance) {
    furi_assert(instance);
    //subghz_environment_reset_keeloq(instance->environment); //Not in OFW

    //subghz_custom_btns_reset(); //Not in OFW
}
